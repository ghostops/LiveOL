            ...
            return (React.createElement(native_base_1.View, { style: { padding: 10 } },
                React.createElement(native_base_1.Card, null,
                    React.createElement(native_base_1.CardItem, { header: true },
                        React.createElement(native_base_1.Title, null, _this.state.comp.name)),
                    ...
                    React.createElement(native_base_1.CardItem, { footer: true },
                        React.createElement(native_base_1.Text, null, _this.state.comp.date))),
                React.createElement(native_base_1.View, { style: {
                        marginVertical: 15,
                        flexDirection: 'row',
                    } },
                    React.createElement(native_base_1.View, { style: { flex: 1 } },
                        React.createElement(native_base_1.Title, { style: { textAlign: 'left' } }, "Classes")),
                    React.createElement(native_base_1.View, null,
                        React.createElement(native_base_1.Button, { small: true, info: true, onPress: function () { return alert(':D'); } },
                            React.createElement(native_base_1.Text, null, "Last Passings")))),
                React.createElement(native_base_1.List, { style: {
                        backgroundColor: '#FFF',
                        borderRadius: 4,
                    } }, _this.state.classes.length < 1 ?
                    (React.createElement(native_base_1.Text, { style: { textAlign: 'center', paddingVertical: 10 } }, "No classes")) : _this.state.classes.map(_this.renderClass))));
        };
        return _this;
    }
