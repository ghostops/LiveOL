...
var OLClub = /** @class */ (function (_super) {
    __extends(OLClub, _super);
    function OLClub() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.state = { club: null, polling: false };
        _this.poll = function () { return __awaiter(_this, void 0, void 0, function () {
            var _a, id, clubName, club;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.props.navigation.state.params, id = _a.id, clubName = _a.clubName;
                        return [4 /*yield*/, api_1.getClub(id, clubName)];
                    case 1:
                        club = _b.sent();
        ...
        _this.renderInner = function () {
            ...
            return (React.createElement(native_base_1.View, { style: {
                ...
                React.createElement(native_base_1.List, { style: {
                        backgroundColor: '#FFF',
                        borderRadius: 4,
                    } }, _this.state.club.results.length < 1 ?
                    (React.createElement(native_base_1.Text, { style: {
                            textAlign: 'center',
                            paddingVertical: 10,
                            fontSize: const_1.UNIT,
                        } }, "No classes")) : _this.state.club.results.map(_this.renderResult))));
        };
        return _this;
    }
    OLClub.prototype.componentWillMount = function () {
        this.poll();
    };
    OLClub.prototype.componentDidMount = function () {
        this.startPoll();
    };
    OLClub.prototype.componentWillUnmount = function () {
        this.clearPoll();
    };
    OLClub.prototype.componentDidUpdate = function (prevProps, prevState) {
