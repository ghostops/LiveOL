...
var OLPassings = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, api_1.getPasses(id)];
                    case 1:
                        passings = _a.sent();
    ...
    OLPassings.prototype.componentWillMount = function () {
        this.getPasses();
    };
    OLPassings.prototype.render = function () {
        return (React.createElement(native_base_1.View, { style: { flex: 1 } }, this.state.passings
            ? this.renderInner()
            : React.createElement(native_base_1.Spinner, { color: "#e86a1e" })));
    };
    OLPassings.navigationOptions = function (_a) {
