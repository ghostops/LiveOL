							...
							return (
								<TouchableOpacity
									...
									style={{
										...
										backgroundColor: lang === activeLanguage ? colors.MAIN : 'transparent',
									}}
									key={lang}
								>
									<OLFlag
										code={lang}
										size={32}
										style={{ borderColor: 'black', borderWidth: 1, marginRight: px(6) }}
									/>
									<OLText
										font={lang === activeLanguage ? 'Proxima_Nova_Bold' : 'Proxima_Nova'}
										size={16}
										style={{ color: lang === activeLanguage ? 'white' : 'black' }}
									>
