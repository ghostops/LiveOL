...
!(function () {
  ...
  var findModals = function (target) {
    var i;
    var modals = document.querySelectorAll('a.modal-toggle');
...
!(function () {
  ...
  window.addEventListener('touchstart', function (e) {
    ...
    var offset      = toggle.classList.contains('active-t') ? (toggleWidth - handleWidth) : 0;
  ...
  window.addEventListener('touchmove', function (e) {
    ...
    toggle.classList[(distanceX > (toggleWidth / 2 - handleWidth / 2)) ? 'add' : 'remove']('active-t');
  });
  ...
  window.addEventListener('touchend', function (e) {
    ...
    var handleWidth = handle.clientWidth;
    var offset      = (toggleWidth - handleWidth);
    var slideOn     = (!touchMove && !toggle.classList.contains('active-t')) || (touchMove && (distanceX > (toggleWidth / 2 - handleWidth / 2)));
    ...
    toggle.classList[slideOn ? 'add' : 'remove']('active-t');
