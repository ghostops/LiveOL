...
import { marshallResult, IOLResult, OLResult } from 'schema/results';
    ...
    fields: () => ({
        getResults: {
            ...
            resolve: async (_, args, { Api }: GQLContext): Promise<IOLResult[]> => {
                ...
                return res.results.map(marshallResult(args.competitionId, args.className, res.splitControlls));
            },
        },
    }),
});
