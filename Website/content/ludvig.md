...
What started as a learning project has become a decade-long journey of continuous improvement, from class-based React components to modern TypeScript, from simple PHP caching to GraphQL and later tRPC.
When not coding or running through the forest, Ludvig works as an IT consultant based in Sweden. [You can find out even more here](https://larsendahl.com/liveol-a-10-year-retrospective).

[Check out his website as well!](https://larsendahl.com)